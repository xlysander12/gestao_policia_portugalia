...
export async function make_request(url: string, method: ("GET" | "POST" | "PATCH" | "DELETE"), body = undefined, force: string | undefined = undefined, useAuth= true, useBaseAPIURL= true) {
