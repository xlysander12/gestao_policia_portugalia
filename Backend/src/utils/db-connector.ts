import {createPool, Pool, PoolOptions, QueryResult, RowDataPacket} from "mysql2/promise";
...
export async function queryDB<T extends QueryResult = RowDataPacket[]>(force: string, query: string, params?: paramsTypes | paramsTypes[]): Promise<T> {
